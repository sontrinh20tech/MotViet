            ...
            <div class="modal-body">
                <form action="{{ route('admin.coupon.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="validate-discount mb-3">
                        ...
                        <input type="number" class="form-control mb-2" name="discount">
                        <div class="text-danger feedback"></div>
                    </div>
                    ...
                    <div class="validate-max_price mb-3">
                        ...
                        <input type="number" class="form-control mb-2" name="max_price">
                        <div class="text-danger feedback"></div>
                    </div>
                    ...
                    <div class="validate-expiration_date">
                        ...
                        <input type="date" class="form-control mb-2" name="expiration_date">
                        <div class="text-danger feedback"></div>
                    </div>
                </form>
            </div>
